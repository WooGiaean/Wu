      ...
      <div class="content-wrapper">
        ...
        <div class="profile-card">
          ...
          <div class="avatar-section">
            <img :src="userInfo.userAvatar ? `/touxiang/${userInfo.userAvatar}` : '/touxiang/blog_avatar-3.png'" 
                 alt="用户头像" 
                 class="profile-avatar"
                 onerror="this.src='https://picsum.photos/seed/avatar/200/200'">
        ...
        <div class="recent-section">
          ...
          <div v-if="recentArticles.length === 0" class="empty-state">暂无文章</div>
        ...
        <div class="recent-section">
          ...
          <div v-if="recentNotes.length === 0" class="empty-state">暂无笔记</div>
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nickname" v-model="editForm.userNickname" placeholder="请输入昵称">
              </div>

              <!-- 邮箱 -->
              <div class="mb-3">
                <label for="email" class="form-label">邮箱</label>
                <input type="email" class="form-control" id="email" v-model="editForm.userEmail" placeholder="请输入邮箱">
              </div>
